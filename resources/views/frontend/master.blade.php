                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        ...
                        <form action="{{route('user.registration')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input required name="name" type="text" class="form-control" id="name" aria-describedby="emailHelp" placeholder="Enter User Name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input  name="mobile" required type="number" class="form-control" id="number" placeholder="Mobile number">
                            </div>

                            <div class="form-group">
                                <label for="address">Address</label>
                                <input required name="address" type="address" class="form-control" id="address" placeholder="address">
                            </div>
                            <div class="form-group">
                                <label for="image">image</label>
                                <input required name="image" type="file" class="form-control" id="image" placeholder="image">
                            </div>
